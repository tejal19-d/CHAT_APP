      ...
      <div className="border-b border-base-300 w-full p-5">
        ...
        <div className="mt-3 hidden lg:block relative">
          <input
            ...
            className="input input-bordered input-sm w-full pl-8 rounded-lg"
          />
          <Search className="size-4 absolute left-2.5 top-2.5 text-zinc-500" />
        </div>
          ...
          >
            ...
            <div className="hidden lg:block text-left min-w-0">
              ...
              <div className="text-xs text-zinc-500 truncate">
                {user.bio || (onlineUsers.includes(user._id) ? "Online" : "Offline")}
              </div>
            </div>
          </button>
        ))}
